...
2. Get the chat ID for the group you want to use your bot in and place it in legalusers.txt (one ID per line)
...
* NEW: With /tts you can get a text to speech version of a random quote
